...
<html lang="vi">
	...
	<title>Đăng nhập &lsaquo; Epic Store  &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="./" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
					...
					<p id="nav">
								<a href="./tai-khoan/lost-password/index.html">Bạn quên mật khẩu?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Quay lại Epic Store </a>		</p>
			</div>
...
var userProfileL10n = {"user_id":"0","nonce":"58e19c8f24"};
</script>
